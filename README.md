...
1. [Time Series](https://docs.ravendb.net/document-extensions/timeseries/overview) + [Rollups](https://docs.ravendb.net/document-extensions/timeseries/rollup-and-retention) — heart-rate data with raw / hourly / daily / monthly tiers, range-to-tier auto-selection at query time.
1. [Subscriptions](https://docs.ravendb.net/client-api/data-subscriptions/what-are-data-subscriptions) — auto-fulfill goals when activity reaches predicate thresholds; fan fulfilled-goal events out to friends.
...
|---|---------------------------------------------------------|
| `openai-api-key` | Get one from OpenAI API platform                        |
